...
const items = [
  {
    icon: GlobeIcon,
    text: "Transparent & Professional Approach",
  },
  {
    icon: BrainGearIcon,
          ...
          {items.map((item, i) => (
            ...
            >
              <div className="mb-5 text-gray-600">
                <item.icon className="mx-auto h-14 w-14 sm:h-16 sm:w-16" />
              </div>
              <p className="text-sm font-medium leading-snug text-gray-600 sm:text-base">
                {item.text}
              </p>
            </div>
          ))}
